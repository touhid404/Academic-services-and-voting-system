...
<body>
        ...
        <div class="container11">
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class='btn' onclick="openModal()">Add route now</button>
                    </div>
    ...
    <div class="modal-background" id="modalBackground">
        <div id="Modal" class="modal">
            ...
            <form method="POST" action="RouteAddProcess.php" class="booking-form">
                <h2>Add a Route</h2>
                ...
                <input type="text" id="busNo" name="busNo" placeholder="Enter Bus Number" required>

                <!-- Route Info -->
                <label for="routeInfo">Route Info</label>
                <textarea name="routeInfo" rows="5" placeholder="Enter Route Info" required></textarea>
                ...
                <input type="text" id="deptTime" name="deptTime" required>
