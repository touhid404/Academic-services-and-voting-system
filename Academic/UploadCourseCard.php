...
<body>
  ...
  <header class="header">
    <br>
    <div class="banner1">Please select the part you want to contribute to.</div>
    <div class="banner"><?php echo $courseName; ?></div>
    <div class="subtitle"><?php echo $courseCode; ?></div>
  </header>

  <main class="dashboard">
    <a class="card" href="UploadQuestion.php?type=Mid-TermQuestions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Mid-Term</div>
      <div class="card-subtitle">Questions</div>
    </a>

    <a class="card" href="UploadQuestion.php?type=FinalQuestions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Final</div>
      <div class="card-subtitle">Questions</div>
    </a>

    <a class="card" href="UploadQuestion.php?type=Mid-TermSolutions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Mid-Term</div>
      <div class="card-subtitle">Solutions</div>
    </a>

    <a class="card" href="UploadQuestion.php?type=FinalSolutions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Final</div>
      <div class="card-subtitle">Solutions</div>
    </a>

    <a class="card" href="UploadQuestion.php?type=Class-Note&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
