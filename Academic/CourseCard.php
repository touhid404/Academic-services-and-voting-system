...
<body>
  ...
  <main class="dashboard">
    <a class="card" href="DisplayQuestion.php?type=Mid-TermQuestions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Mid-Term</div>
      <div class="card-subtitle">Questions</div>
    </a>

    <a class="card" href="DisplayQuestion.php?type=FinalQuestions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Final</div>
      <div class="card-subtitle">Questions</div>
    </a>

    <a class="card" href="DisplayQuestion.php?type=Mid-TermSolutions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Mid-Term</div>
      <div class="card-subtitle">Solutions</div>
    </a>

    <a class="card" href="DisplayQuestion.php?type=FinalSolutions&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
      <div class="card-title">Final</div>
      <div class="card-subtitle">Solutions</div>
    </a>

    <a class="card" href="DisplayQuestion.php?type=Class-Note&courseName=<?php echo urlencode($courseName); ?>&courseCode=<?php echo urlencode($courseCode); ?>&cardColor=<?php echo urlencode($cardColor); ?>">
